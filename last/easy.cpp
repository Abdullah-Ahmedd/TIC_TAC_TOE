    ...
    : QMainWindow(parent), gameOver(false)
{
    ...
    connect(undoButton, &QPushButton::clicked, this, &easy::undoMove);
    connect(backButton, &QPushButton::clicked, this, &easy::backToLevel);
...
void easy::handleCellClicked(int row, int col)
{
...
void easy::applyMove(int row, int col, const QString& symbol)
{
...
void easy::clearCell(int row, int col)
{
...
bool easy::checkWinner(const QString& symbol)
{
    for (int i = 0; i < 3; ++i)
